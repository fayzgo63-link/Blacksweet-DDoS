...
print(f"\033[92m║\033[48;5;1m\033[97m  BIRRUH BIDDAM NAFDHIKA YA AQSA {' ' * 35} \033[0m\033[92m║")
print(f"\033[92m╚{'═' * 69}╝")
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                u += 1
                print(f"\033[38;5;220m[B'sweet]\033[37m->Target: \033[36m" +url+ " \033[32mrequests.\033[96mget(randomized_url,)\033[0m"))
